                ...
                )
{
                ...
                $full_link="farm_workers_inventory_delete.php?l=".$limit."&s=".$skip."&sc=".$sort_column."&so=".$sort_order."&re=".$rows_every."&data=".$_GET['data']."&data_1=".$_GET['data_1'];//for form submission
               $return_link="farm_workers_inventory.php?l=".$limit."&s=".$skip."&sc=".$sort_column."&so=".$sort_order."&re=".$rows_every."&data=".$_GET['data'];//for form submission
                 ...
                 $statement='Are you sure you want to remove the entry for used inventory bags '.strtoupper(number_format($inventory_data['quantity'])).'? <span><a href="'.$full_link.'&a=yes" style="color:red">[YES]</a></span>  &nbsp;&nbsp;&nbsp;&nbsp;  <span ><a href="'.$return_link.'" style="color:green">[NO]</a></span> ';
                    ...
                    if(isset($_GET['a']) && !empty($_GET['a']) )
                    {
                        ...
                        {
                            //delete
                            $returned_json_decoded= json_decode(send_curl_post(the_api_requests_url."user_remove_inventory/",'_id='.$inventory_data['_id'],array("Customkey: ".$_SESSION['token_type']." ".$_SESSION['token'] )),true);//decode
...
<head>
    ...
    <title>Farm worker inventory delete</title>
