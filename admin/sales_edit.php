                ...
                )
{
                ...
                $sale_data= json_decode(base64_decode($_GET['data'],true),true);
               

                $action_page="sales_edit.php?l=".$limit."&s=".$skip."&sc=".$sort_column."&so=".$sort_order."&re=".$rows_every."&data=".$_GET['data'];//for form submission
               $return_page="sales.php?l=".$limit."&s=".$skip."&sc=".$sort_column."&so=".$sort_order."&re=".$rows_every;//for form submission
...
<div class="row">
    ...
    <div class=" table-responsive">
     <table class="table">
                    <tr>
                        <th>Farm telephone_number</th>
                        <td><?php echo $sale_data["users_from_telephone_number"]?></td>
                    </tr>
                    <tr>
                        <th>Farm full_names</th>
                        <td><?php echo $sale_data["users_from_full_names"]?></td>
                    </tr>
                  
                     <tr>
                        <th>Buyer telephone_number</th>
                        <td><?php echo $sale_data["users_to_telephone_number"]?></td>
                    </tr>
                    <tr>
                        <th>Buyer full_names</th>
                        <td><?php echo $sale_data["users_to_full_names"]?></td>
                    </tr>
                </table>
</div>
</div>
