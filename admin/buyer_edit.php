                ...
                )
{
                ...
                $action_page="buyer_edit.php?l=".$limit."&s=".$skip."&sc=".$sort_column."&so=".$sort_order."&re=".$rows_every."&data=".$_GET['data'];//for form submission
               ...
               if(isset($_POST['telephone_number']) && !empty($_POST['telephone_number']) &&
...

                    {
                        $vars='telephone_number='.$_POST['telephone_number'].
                                ...
                                '&_id='.$_POST['_id'];
                             $returned_json_decoded= json_decode(send_curl_post(the_api_requests_url."user_edit_buyer_user/",$vars,array("Customkey: ".$_SESSION['token_type']." ".$_SESSION['token'] )),true);//decode
...
<form method="POST">
    ...
    <input type="number" required name="cost_per_crate"   placeholder="cost_per_crate" value="<?php echo $user_data['cost_per_crate']?>">
  <input type="number" required name="cost_per_egg"   placeholder="cost_per_egg" value="<?php echo $user_data['cost_per_egg']?>">
  <input type="number" required name="eggs_for_crate"   placeholder="eggs_for_crate" value="<?php echo $user_data['eggs_for_crate']?>">
