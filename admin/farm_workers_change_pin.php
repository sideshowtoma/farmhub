                ...
                )
{
                ...
                $action_page="farm_workers_change_pin.php?l=".$limit."&s=".$skip."&sc=".$sort_column."&so=".$sort_order."&re=".$rows_every."&data=".$_GET['data'];//for form submission
               ...
               if(
                    ...
                    {
                        $vars='new_password='.$_POST['new_password'].
                                '&confirm_password='.$_POST['confirm_password'].
                                '&_id='.$_POST['_id'];
                             $returned_json_decoded= json_decode(send_curl_post(the_api_requests_url."user_change_user_password_master/",$vars,array("Customkey: ".$_SESSION['token_type']." ".$_SESSION['token'] )),true);//decode
...
<head>
    ...
    <title>Farm workers change pin</title>
