                ...
                )
{
                ...
                $action_page="farm_workers.php?l=".$limit."&s=".$skip."&sc=".$sort_column."&so=".$sort_order."&re=".$rows_every;//for form submission
                ...
                $link_without_sort_column_sort_order="farm_workers.php?l=".$limit."&s=".$skip."&re=".$rows_every;//for headers sorting
                $link_without_limit_skip_rows_every="farm_workers.php?sc=".$sort_column."&so=".$sort_order;//for browsing
                        ...
                        ( $_POST['skip_is']==0 || is_numeric($_POST['skip_is']) ))
                {
...

                    {
                        $vars='telephone_number='.$_POST['telephone_number'].
                             ...
                             $returned_json_decoded= json_decode(send_curl_post(the_api_requests_url."user_create_farm_user/",$vars,array("Customkey: ".$_SESSION['token_type']." ".$_SESSION['token'] )),true);//decode
...
<form method="POST">
    ...
    <input type="number" required name="number_of_line"   placeholder="number_of_line">
    
   
    <input type="password" required name="new_password"  placeholder="Pin"   >
    ...
    <table>
        <tr>
            ...
            <th><a href="<?php echo $link_without_sort_column_sort_order?>&sc=number_of_line&so=<?php echo return_script_order($sort_column,$sort_order,"number_of_line")?>">Number of lines</a></th>
            ...
            <th><a href="<?php echo $link_without_sort_column_sort_order?>&sc=time_stamp&so=<?php echo return_script_order($sort_column,$sort_order,"time_stamp")?>">Change pin</a></th>
            ...
            <th><a href="<?php echo $link_without_sort_column_sort_order?>&sc=time_stamp&so=<?php echo return_script_order($sort_column,$sort_order,"time_stamp")?>">Production</a></th>
            <th><a href="<?php echo $link_without_sort_column_sort_order?>&sc=time_stamp&so=<?php echo return_script_order($sort_column,$sort_order,"time_stamp")?>">Inventory usage</a></th>
        </tr>
        <?php
    
                            $returned_json_decoded= json_decode(send_curl_post(the_api_requests_url."user_fetch_users/",'sort_by='.$sort_column.'&sort_order='.$sort_order.'&limit='.$limit.'&skip='.$skip.'&level=2&search_phrase='.$_GET['search_phrase'].'',array("Customkey: ".$_SESSION['token_type']." ".$_SESSION['token'] )),true);//decode
                            ...
                            if($returned_json_decoded["check"]==true)//if login is true
                            {
                                ...
                                foreach ($returned_json_decoded["message"] as $value) 
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo number_format($value['number_of_line'])?></td>
                                       ...
                                       <td><a href="farm_workers_edit.php?<?php echo $action_page_without_page_name?>&data=<?php echo base64_encode(json_encode($value))?>">Edit</a></td>
                                        <td><a href="farm_workers_change_pin.php?<?php echo $action_page_without_page_name?>&data=<?php echo base64_encode(json_encode($value))?>">Change pin</a></td>
                                        <td><a href="farm_workers_sales.php?<?php echo $action_page_without_page_name?>&data=<?php echo base64_encode(json_encode($value))?>">Sales</a></td>
                                         <td><a href="farm_workers_production.php?<?php echo $action_page_without_page_name?>&data=<?php echo base64_encode(json_encode($value))?>">Production</a></td>
                                         <td><a href="farm_workers_inventory.php?<?php echo $action_page_without_page_name?>&data=<?php echo base64_encode(json_encode($value))?>">Inventory usage</a></td>
